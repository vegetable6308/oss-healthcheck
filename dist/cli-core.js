...
import { assertSafeOutputPath, renderReport } from "./reporters.js";
...
export async function runCli(args, io) {
    try {
        ...
        if (parsed.command === "init") {
            ...
            io.stdout(`Created ${String(result.created.length)} file(s); skipped ${String(result.skipped.length)} existing file(s).\n`);
